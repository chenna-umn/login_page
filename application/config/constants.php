...
defined("FILE_READ_MODE") or define("FILE_READ_MODE", 420);
defined("FILE_WRITE_MODE") or define("FILE_WRITE_MODE", 438);
defined("DIR_READ_MODE") or define("DIR_READ_MODE", 493);
defined("DIR_WRITE_MODE") or define("DIR_WRITE_MODE", 493);
