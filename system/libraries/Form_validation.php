    ...
    public function run($group = "")
    {
        ...
        if( count($this->_field_data) === 0 ) 
        {
            ...
            if( empty($group) ) 
            {
                ...
                isset($this->_config_rules[$group]) or                 if( count($this->_field_data) === 0 ) 
                {
        ...
        empty($this->validation_data) and $this->_reset_post_array();
    ...
    protected function _reset_post_array()
    {
        foreach( $this->_field_data as $field => $row ) 
        {
            if( $row["postdata"] !== NULL ) 
            {
                ...
                {
                    isset($_POST[$field]) and $_POST[$field] = $row["postdata"];
                }
                else
                {
                    global $_POST;
