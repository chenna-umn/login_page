...
abstract class CI_DB_forge
{
    ...
    public function create_database($db_name)
    {
        ...
        if( !$this->db->query(sprintf($this->_create_database, $this->db->escape_identifiers($db_name), $this->db->char_set, $this->db->dbcollat)) ) 
        {
    ...
    public function drop_database($db_name)
    {
        ...
        if( !$this->db->query(sprintf($this->_drop_database, $this->db->escape_identifiers($db_name))) ) 
        {
            return ($this->db->db_debug ? $this->db->display_error("db_unable_to_drop") : false);
        }
    ...
    public function create_table($table, $if_not_exists = false, array $attributes = array(  ))
    {
        ...
        {
            isset($this->db->data_cache["table_names"]) and $this->db->data_cache["table_names"][] = $table;
            if( !empty($this->keys) ) 
            {
                $i = 0;
